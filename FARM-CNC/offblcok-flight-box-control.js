...
const offBlockFlightBoxControl = function() {
            ...
            $(flightBox).find(".collapse-btn > img").click(function() {
                ...
                if (updateTimeBtn.hasClass("closed")) {
                    if ($(this).hasClass("closed")) {
                        ...
                        siblingsflightBox.find(".update-time-btn").text("").append("<img src='./FARM-CNC-image/update-time.svg'> Check Time").css({
            ...
            $(flightBox).find(".update-time-btn").click(function() {
                ...
                if (aircraftBtn.hasClass("closed")) {
                    if ($(this).hasClass("closed")) {
                        ...
                        $(this).text("").append("<img src='./FARM-CNC-image/update-time.svg'> Check Time").css({
                                "background": "#CBB1F9  0% 0% no-repeat padding-box",
                                "border": "1px solid #3E075B",
                                "margin-bottom": "0px",
                                "margin-top": "10px"
