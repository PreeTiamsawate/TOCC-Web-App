$(document).ready(function() {
    const timeControl = function() {
        ...
        for (let flightBox of flightBoxes) {
            ...
            $(flightBox).find(".STA").text(customGetHours(STA) + customGetMinutes(STA))
            $(flightBox).find(".ETA").text(customGetHours(ETA) + customGetMinutes(ETA))
            ...
            $(flightBox).find(".next_flight_STD").text(customGetHours(nextFlightSTDDateTime) + ":" + customGetMinutes(nextFlightSTDDateTime))
